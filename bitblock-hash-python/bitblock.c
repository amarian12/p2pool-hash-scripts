...
void bitblock_hash(const char* input, char* output)
{
    ...
    sph_luffa512(&ctx_luffa1, hash + 64, 64);
    sph_luffa512_close(&ctx_luffa1, hash);

    sph_cubehash512_init(&ctx_cubehash1);
    sph_cubehash512(&ctx_cubehash1, hash, 64);
    sph_cubehash512_close(&ctx_cubehash1, hash + 64);

    sph_shavite512_init(&ctx_shavite1);
    sph_shavite512(&ctx_shavite1, hash + 64, 64);
    sph_shavite512_close(&ctx_shavite1, hash);

    sph_simd512_init(&ctx_simd1);
    sph_simd512(&ctx_simd1, hash, 64);
    sph_simd512_close(&ctx_simd1, hash + 64);

    sph_echo512_init(&ctx_echo1);
    sph_echo512(&ctx_echo1, hash + 64, 64);
    sph_echo512_close(&ctx_echo1, hash);

    sph_hamsi512_init(&ctx_hamsi1);
    sph_hamsi512(&ctx_hamsi1, hash, 64);
    sph_hamsi512_close(&ctx_hamsi1, hash + 64);

    sph_fugue512_init(&ctx_fugue1);
    sph_fugue512(&ctx_fugue1, hash + 64, 64);
    sph_fugue512_close(&ctx_fugue1, hash);

    sph_shabal512_init(&ctx_shabal1);
    sph_shabal512(&ctx_shabal1, hash, 64);
    sph_shabal512_close(&ctx_shabal1, hash + 64);

    sph_whirlpool_init(&ctx_whirlpool1);
    sph_whirlpool(&ctx_whirlpool1, hash + 64, 64);
